...
model = dict(
    ...
    prefix_1dataset='points_rgb',
    prefix_2dataset='__unused__',
...
data_prefix = dict(
    pts='processed/points_rgb',
    pts_instance_mask='processed/instance_mask_rgb',
    pts_semantic_mask='processed/semantic_mask_rgb')
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='derived/infos/forainetv2_rgb_combined_oneformer3d_infos_train.pkl',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root_forainetv2,
        ann_file='derived/infos/forainetv2_rgb_combined_oneformer3d_infos_val.pkl',
        data_prefix=data_prefix,
...
test_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root_forainetv2,
        ann_file='derived/infos/forainetv2_rgb_combined_oneformer3d_infos_test.pkl',
        data_prefix=data_prefix,
