...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='derived/infos/forainetv2_rgb_cass_oneformer3d_infos_train.pkl',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root_forainetv2,
        ann_file='derived/infos/forainetv2_rgb_cass_oneformer3d_infos_val.pkl',
        data_prefix=data_prefix,
...
test_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root_forainetv2,
        ann_file='derived/infos/forainetv2_rgb_cass_oneformer3d_infos_test.pkl',
        data_prefix=data_prefix,
